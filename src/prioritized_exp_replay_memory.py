...
class PrioritizedExperienceReplayMemory(object):  # stored as ( s, a, r, s_ ) in SumTree
    """
    ...
    def store(self, experience):
        ...
        if self.nb_stored < self.tree.capacity:
            self.nb_stored += 1
    ...
    def sample(self, n):
        ...
        assert p_min > 0, "p_min est à zéro !"
